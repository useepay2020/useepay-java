...
public class RequestOptions {
  ...
  private final String useePayAccount;
  private final String baseUrl;
  /** Stripe version always set at {@link UseePay#API_VERSION}. */
  private final String useePayVersion = UseePay.API_VERSION;
  /**
   * Stripe version override when made on behalf of others. This can be used when the returned
   * response will not be deserialized into the current classes pinned to {@link UseePay#VERSION}.
   */
  ...
  private RequestOptions(
    ...
    this.useePayAccount = useePayAccount;
  ...
  public String getUseePayAccount() {
    return useePayAccount;
  }

  public String getUseePayVersion() {
    return useePayVersion;
  }
  ...
  public RequestOptionsBuilder toBuilder() {
    return new RequestOptionsBuilder().setApiKey(this.apiKey).setStripeAccount(this.getUseePayAccount());
  }
  ...
  public RequestOptionsBuilder toBuilderFullCopy() {
    return RequestOptionsBuilder.unsafeSetStripeVersionOverride(
        new RequestOptionsBuilder()
            ...
            .setStripeAccount(this.useePayAccount)
  ...
  static RequestOptions merge(UseePayResponseGetterOptions clientOptions, RequestOptions options) {
    if (options == null) {
      return new RequestOptions(
